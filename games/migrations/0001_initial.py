    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_at', models.DateTimeField(default=django.utils.timezone.now, validators=[games.models.check_date], verbose_name='開始日時')),
            ],
        ),
        migrations.CreateModel(
            name='GameCategory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='game_result', to='games.game', verbose_name='試合')),
        ...
        migrations.AddField(
            model_name='game',
            name='player1',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='game_player1', to=settings.AUTH_USER_MODEL, verbose_name='player1'),
        ),
        migrations.AddField(
            model_name='game',
            name='player2',
